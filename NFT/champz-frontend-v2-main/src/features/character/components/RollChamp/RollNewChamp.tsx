...
import createPriestButton from '@/assets/backgrounds/buttons/createPriestButton.svg';
import character from "@/assets/character1.svg"; 
import rollBannerBackground from '@/assets/backgrounds/rollBannerBackground.svg';
import { ClassList } from '@/features/charlist/components/ClassList';
...
const CreatePriestButton = styled('button')(({ theme }) => ({
  marginTop: '21px',
  marginBottom: '28px',
  ...
  minHeight: '66px',
  fontWeight: '1000',
  backgroundImage: `url(${createPriestButton})`,
  backgroundSize: 'cover',
